...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case tribute:
        return playTribute(state, tributeRevealedCards, currentPlayer, handPos);
...
int playTribute(struct gameState *state, int *tributeRevealedCards, int currentPlayer, int handPos){
    int i;
    int nextPlayer = currentPlayer + 1;
    // int tributeRevealedCards[2] = {-1, -1};
